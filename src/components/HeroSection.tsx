...
const HeroSection = () => {
  ...
  return (
    <div className="min-h-screen  bg-yellow-500 flex flex-col">
      {/* Main Hero Section */}
        ...
        <div className=" w-full flex-1 bg-cover  px-8  py-12 relative"
  ...
  <span className="text-gray-800 font-medium">See how it works</span>
</button>
              </div>
            </div>
      ...
      <div className="bg-white  pt-12 flex-1  border-t">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {[{name:'ORACLE',value:oracle}, {name:'MORPHEUS',value:c2}, {name:'SAMSUNG',value:c3}, {name:'MONDAY',value:c4}, {name:'SEGMENT',value:c5}].map(({name,value}, index) => (
